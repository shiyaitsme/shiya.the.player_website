          ...
          >
            ...
            {!work.video && links.length > 0 && imgOk && (
              <span className="pointer-events-none absolute inset-0 grid place-items-center">
                <span className="grid h-14 w-14 place-items-center rounded-full bg-black/25 backdrop-blur-sm transition-transform duration-200 group-hover:scale-110 md:h-16 md:w-16">
